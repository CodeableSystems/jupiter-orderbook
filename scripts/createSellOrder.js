...
const inputMint = "5qKDWkBejLtRh1UGFV7e58QEkdn2fRyH5ehVXqUYujNW";//SCOIN
const outputMint = "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v";//USDC

// Base key are used to generate a unique order id
const base = Keypair.generate();

const getCurrentPrice = await fetch(`https://quote-api.jup.ag/v6/quote?inputMint=${outputMint}&outputMint=${inputMint}&amount=1000000&slippageBps=50&onlyDirectRoutes=false&experimentalDexes=Jupiter LO`)
const currentPrice = await getCurrentPrice.json()

const scoinAmount = 200000;
...
const transactions = await (
  await fetch('https://jup.ag/api/limit/v1/createOrder', {
    ...
    body: JSON.stringify({
      ...
      inAmount: scoinAmount * 1e9,//currentPrice.inAmount*scoinAmount,
      outAmount: scoinAmount * 1220,
